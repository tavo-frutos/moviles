...
class Sugerencias (var adaptador: Catalogo.productosadaptador?=null): AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        listaproducto.add(producto(1,12.2F,5,"Bleach"))
        listaproducto.add(producto(1,15.2F,3,"Night Walker"))


        adaptador = Catalogo.productosadaptador(this, this.listaproducto)

        productosugerencia.adapter=adaptador
